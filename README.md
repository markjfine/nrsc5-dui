...
The user can override what the stations send by enabling the DL Album Art setting. This will use the Title and Artist information to search Discogs and retrieve album art. If no album art is found, the station logo will be used, if available.
